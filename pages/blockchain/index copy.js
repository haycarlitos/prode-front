...
export default function Blockchain() {
  ...
  async function execute() {
    console.warn('hello')
    if (typeof window.ethereum !== "undefined") {
      const contractAddress = "0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D2";
      
      const contract = new ethers.Contract(contractAddress, contractABI, signer);
      try {
        const prodeTxn = await contract.name();

        console.log("Mining...", typeof(prodeTxn));

        await prodeTxn.wait();
        console.log("Mined -- ", prodeTxn.hash);
